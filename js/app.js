...
// 本プロジェクトはGITHUBにて公開されています。

// ソースコードの閲覧、改変、再配布は自由に行えます。
// https://github.com/ShionGT/Blackjack

// また、オンライン版も公開しています。
// https://shiongt.github.io/Blackjack/

// 新しいHTMLファイルを作成てもいいのかが、わからず、オリジナル製に欠けています。
// ご了承ください.
